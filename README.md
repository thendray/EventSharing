 ...
 **Корпоративная** - подписка для компаний и корпараций, обладающих большим колличесвтом мероприятий. В подписку входит функционал премиум + безлимитная пубикация событий и мероприятий и ускоренная верификация
***
...
![MVVM](https://github.com/thendray/EventSharing/blob/main/img/newArch.jpg)
