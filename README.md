...
4. Программа должна удалять информацию с карты о прошедших событиях и сохранять в архив
...
13. Программа должна сохранять введённые пользоваетлем данные о мероприятие в базе данных
14. Если информация о мероприятии размещается не с корпоративных аккаунтов или с не верифицированных на сайте аккаунтов, программа должна отправлять данные на дополнительную проверку
